 ...
 * @author alumno
 */
@WebServlet("/adm/solicitudalquiler")
public class SolicitudAlquilerController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        RequestDispatcher rd = req.getRequestDispatcher("/WEB-INF/adm/local/solicitudalquiler.jsp");
        rd.forward(req, resp);
